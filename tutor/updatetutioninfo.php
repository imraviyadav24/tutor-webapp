  ...
  color: #A92A2A;">'.$succs_message.'</div>';
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
													...
													<div class="divp50"><input <?php $sub1=strstr($sub, "Maths"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Maths"><span>Maths</span></div>
													...
													<div class="divp50"><input <?php $sub1=strstr($sub, "Sanscrit"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Sanscrit"><span>Sanscrit</span></div>
													...
													<div class="divp50"><input <?php $sub1=strstr($sub, "Accounts"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Accounts"><span>Accounts</span></div>
													...
													<div class="divp50"><input <?php $sub1=strstr($sub, "Music"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Music"><span>Music</span></div>
											...
											<div class="itemrow">
									  			...
									  			<div style="width: 80%; float: left;">
													...
													<div class="divp50"><input <?php $class1=strstr($cls, "Four-Six"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Four-Six"><span>Four-Six</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Seven-Eight"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Seven-Eight"><span>Seven-Eight</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Nine"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Nine"><span>Nine</span></div>
													<div class="divp50"><input <?php $class1=strstr($cls, "Ten"); if($class1 != '') echo 'checked'; ?> type="checkbox" name="class_list[]" value="Ten"><span>Ten</span></div>
